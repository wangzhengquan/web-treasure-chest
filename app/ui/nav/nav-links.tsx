...
export function NavLinksGroup({title, links, onClickLink, defaultCollapsed} : {title: string, links: TNavLink[], onClickLink?: (event: React.MouseEvent<HTMLElement>) => void, defaultCollapsed?: boolean}) {
